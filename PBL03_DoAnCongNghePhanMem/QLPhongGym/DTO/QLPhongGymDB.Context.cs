...
public partial class QLPhongGymDB : DbContext
{
    ...
    public virtual DbSet<LichTrinhTap> LichTrinhTaps { get; set; }
    ...
    public virtual DbSet<TinhTrangHLV> TinhTrangHLVs { get; set; }

    public virtual DbSet<TK> TKs { get; set; }

    public virtual DbSet<User> Users { get; set; }

    public virtual DbSet<HLV_KH> HLV_KH { get; set; }

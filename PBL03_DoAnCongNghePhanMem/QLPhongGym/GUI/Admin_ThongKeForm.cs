...
namespace QLPhongGym.GUI
{
    public partial class Admin_ThongKeForm : Form
    {
        ...
        public void LoadDuLieuBieuDo()
        {
            ...
            chart_doanhthu.ChartAreas[0].AxisX.TitleFont = new Font("Time new roman", 14, FontStyle.Bold);
            ...
            chart_doanhthu.ChartAreas[0].AxisY.TitleFont = new Font("Time new roman", 14, FontStyle.Bold);
        ...
        public void LoadDuLieuBieuDoSoLuongDangKiGoi()
        {
            ...
            chart_soluongdkgt.ChartAreas[0].AxisX.TitleFont = new Font("Time new roman", 14, FontStyle.Bold);
            ...
            chart_soluongdkgt.ChartAreas[0].AxisY.TitleFont = new Font("Time new roman", 13, FontStyle.Bold);
        }
        public void LoadDuLieuBieuDoNhuCauDangKiGoi()
        {
            ...
            chart_nhucaudkgt.ChartAreas[0].AxisX.TitleFont = new Font("Time new roman", 14, FontStyle.Bold);
            ...
            chart_nhucaudkgt.ChartAreas[0].AxisY.TitleFont = new Font("Time new roman", 14, FontStyle.Bold);
